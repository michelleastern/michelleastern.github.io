...
![](images/Stern_Pic.jpg){width=90 alt="Michelle Stern headshot"}
...
3. Flint, L. E.; Flint, A. L.; Stern, M. A. (2021). "The Basin Characterization Model—A Monthly Regional Waterbalance Software Package (BCMv8) Data Release and Model Archive for Hydrologic California." USGS Data Release.  
    [https://doi.org/10.5066/P9PT36UI](https://doi.org/10.5066/P9PT36UI)

    Provides a publicly available model archive and data release (BCMv8) used to produce historical and future monthly climate and hydrology datasets across California.
...
9. Stern, M.; Ferrell, R.; Flint, L.; Kozanitas, M.; Ackerly, D.; Elston, J.; Stachura, M.; Dai, E.; Thorne, J. (2024). "Fine‑scale surficial soil moisture mapping using UAS‑based L‑band remote sensing in a mixed oak‑grassland landscape." *Frontiers in Remote Sensing*, 5:1337953.  
   ...
   Demonstrates how an unmanned aircraft system (UAS) L‑band radiometer can map soil moisture at fine scales to support fire‑risk and ecological monitoring.
...
- L‑band radar UAS surveys: high‑resolution soil moisture mapping to improve fire‑danger and ecological monitoring.
...
I strive to practice open data practices. Most of my data releases and model archives are available through USGS data releases and institutional repositories (see publications for dataset DOIs). If you need a specific dataset or model archive, contact me.
